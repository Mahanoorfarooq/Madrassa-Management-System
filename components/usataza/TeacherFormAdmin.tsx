    ...
    >
      ...
      <div className="flex justify-end mt-6 pt-5 border-t border-gray-200">
        <button
          type="submit"
          disabled={loading}
          className="flex items-center gap-2 rounded-lg bg-primary text-white px-6 py-2.5 text-sm font-semibold hover:bg-primary/90 transition-all shadow-md disabled:opacity-50"
        >
