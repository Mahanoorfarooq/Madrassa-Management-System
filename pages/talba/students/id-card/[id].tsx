...
export default function StudentIdCard() {
  ...
  if (loading)
    return (
      <div className="p-10 text-center font-urdu text-lg">لوڈ ہو رہا ہے...</div>
    );
  if (error)
    return (
      <div className="p-10 text-center text-red-500 font-urdu">{error}</div>
    );
  if (!student)
    return (
      <div className="p-10 text-center font-urdu text-lg">
        طالب علم نہیں ملا۔
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col items-center justify-center p-4">
      ...
      <div
        className={`print:m-0 print:p-0 flex flex-col items-center gap-6 ${printMode}`}
      >
        {/* ================= FRONT SIDE ================= */}
        <div
          id="id-card-front"
          className={`relative bg-white shadow-2xl overflow-hidden font-sans border border-gray-100 print:shadow-none print:border-none page-break-after ${
            printMode === "back" ? "hidden-on-print" : ""
          }`}
          style={{
            width: "120mm",
            height: "76mm",
        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 h-[38%] bg-[#00695c] text-white flex items-center justify-between px-8">
            ...
            <div className="z-10 text-right font-urdu" dir="rtl">
              <div className="text-[18px] font-bold leading-tight mb-0.5 opacity-90">
          ...
          <div className="absolute top-[46%] left-10 z-20">
            <div className="w-[33mm] h-[33mm] rounded-full border-[5px] border-white overflow-hidden bg-gray-50 shadow-xl flex items-center justify-center">
              {photoSrc ? (
                ...
                <div className="text-gray-400 text-xs font-urdu text-center px-2">
                  تصویر موجود نہیں
                </div>
              )}
            </div>
          ...
          <div
            className="absolute top-[44%] right-10 left-[48mm] text-right font-urdu"
            dir="rtl"
          >
            <div className="space-y-1">
              <div className="border-b border-dashed border-gray-200 pb-1">
                <div className="text-[9px] text-gray-400 font-bold leading-none mb-0.5">
                  نام طالب علم:
                </div>
                <div className="text-[18px] font-black text-gray-900 leading-tight">
              ...
              <div className="mt-1">
                ...
                <div
                  className="text-[13px] font-bold text-gray-800 leading-none"
                  dir="ltr"
                >
        ...
        <div
          id="id-card-back"
          className={`relative bg-white shadow-2xl overflow-hidden font-sans border border-gray-100 print:shadow-none print:border-none print:mt-4 ${
            printMode === "front" ? "hidden-on-print" : ""
          }`}
          style={{
            width: "120mm",
            height: "76mm",
        ...
        >
          ...
          <div
            className="absolute top-[12%] left-6 right-6 bottom-[12%] flex flex-col justify-center gap-4 font-urdu text-right"
            dir="rtl"
          >
            {/* Student CNIC / ID Card Number */}
            <div className="border-b border-gray-200 pb-2">
              <div className="text-[10px] text-gray-400 font-bold leading-none mb-1 text-center">
                شناختی کارڈ نمبر (Student ID Card):
              </div>
              <div
                className="text-[22px] font-black text-gray-900 tracking-wider text-center"
                dir="ltr"
              >
                {student.cnic || "—"}
              </div>
            ...
            <div className="flex-1">
              <div className="text-[10px] text-gray-400 font-bold leading-none mb-1">
                مستقل پتہ:
              </div>
            ...
            <div className="text-[10px] text-gray-500 leading-tight border-t border-gray-200 pt-2 text-center">
              یہ کارڈ گم ہونے کی صورت میں براہ کرم نیچے دیے گئے پتے پر ارسال
              فرمائیں یا ادارے سے رابطہ کریں۔
              <div className="font-bold text-[#00695c] mt-0.5 text-[11px]">
                الجامعہ الاسلامیہ السلفیہ
              </div>
            </div>
          </div>
