      ...
      <div className="max-w-[21cm] mx-auto border-2 border-black p-6 relative">
          ...
          <table className="flex-1 border-collapse border-2 border-black text-xs">
            <tbody>
              ...
              <tr>
                ...
                >
                  {student.dateOfBirth
                    ? new Date(student.dateOfBirth).toLocaleDateString("en-PK")
                    : "—"}
                </td>
                <td className="border border-black bg-gray-100 p-1 font-bold text-center">
                  الحاق نمبر
                ...
                <tr>
                  ...
                  >
                    ...
                    <p className="text-sm">
                      ...
                      &quot;امتحانات&quot; سیکشن میں اس کلاس کا شیڈول تیار کریں۔
                    </p>
                  </td>
                </tr>
              ) : (
        ...
        <div className="border-t border-black pt-4">
          ...
          <ol className="list-decimal list-inside space-y-0.5 text-[11px] leading-snug pr-2">
            <li>
              امیدوار کا امتحانی مرکز میں پرچہ شروع ہونے سے 15 منٹ قبل آنا ضروری
              ہے۔
            </li>
            <li>
              امیدوار اصل رول نمبر سلپ ہمراہ لائے گا بصورت دیگر اسے امتحان میں
              شرکت کی اجازت نہیں ہوگی۔
            </li>
            <li>
            ...
            <li>
              دورانِ امتحانات ایک دوسرے سے مدد لینا اور دینا جرم ہے۔ ایسا کرنے
              پر نگران عملہ امیدوار کو کمرہ امتحان سے باہر نکال سکتا ہے۔
            </li>
            <li>
              امیدوار صرف ان ہی مضامین کا امتحان دے سکتا ہے جو رول نمبر سلپ پر
              درج ہیں، اگر اس میں کوئی غلطی ہو تو امتحان سے قبل دفتر وفاق سے اس
              کی تصحیح کروالی جائے۔
            </li>
            <li>
              امیدوار کے لیے مقرر کردہ امتحانی مرکز کسی حالت میں تبدیل نہیں کیا
              جائے گا۔
            </li>
            <li>
              امیدوار اپنا شناختی کارڈ (شناختی کارڈ نہ ہونے کی صورت میں کوئی
              شناختی ثبوت) اپنے پاس رکھے تاکہ نگران عملہ جان سکے کہ اصل امیدوار
              ہی امتحان دے رہا ہے۔
            </li>
            <li>
