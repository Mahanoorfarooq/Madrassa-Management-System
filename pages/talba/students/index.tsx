        ...
        <div className="bg-secondary rounded-2xl shadow-lg p-6 text-white">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-secondary hover:opacity-90 text-white px-5 py-3 text-sm font-semibold shadow-lg transition-all"
            >
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white/80 text-xs mb-1">کل طلباء</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white/80 text-xs mb-1">فعال</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white/80 text-xs mb-1">نکل چکے</p>
              ...
              return (
                <Link
                  ...
                  className={`text-sm font-semibold rounded-xl px-6 py-3 transition-all duration-200 ${
                    active
                      ? "bg-secondary text-white shadow-lg hover:opacity-90"
          ...
          <div className="bg-gray-50 px-6 py-4 border-b flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Link
                ...
                target="_blank"
                className="inline-flex items-center gap-2 bg-secondary text-white hover:opacity-90 rounded-lg px-4 py-2 text-sm font-semibold shadow transition-all"
              >
              ...
              {classId && (
                <Link
                  href={{
                    ...
                    query: {
                      className:
                        classes.find((c) => c._id === classId)?.label || "",
                    },
                  }}
                  target="_blank"
                  className="inline-flex items-center gap-2 bg-secondary text-white hover:opacity-90 rounded-lg px-4 py-2 text-sm font-semibold shadow transition-all"
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full rounded-lg border-2 border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-primary hover:border-gray-300"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                disabled={!classId}
                className="w-full rounded-lg border-2 border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-primary hover:border-gray-300 disabled:bg-gray-100 disabled:cursor-not-allowed"
              >
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        ...
                        <Link
                          ...
                          className="inline-flex items-center gap-2 text-primary font-medium hover:underline mr-4"
                          target="_blank"
                        >
