...
export default function TajweedDashboard() {
  ...
  const quickLinks = [
    { href: "/talba/students?dept=TAJWEED", label: "نیا طالب علم شامل کریں" },
    { href: "/talba/teachers?dept=TAJWEED", label: "نیا استاد شامل کریں" },
    { href: "/talba/classes?dept=TAJWEED", label: "نئی کلاس بنائیں" },
    { href: "/talba/attendance?dept=TAJWEED", label: "آج کی حاضری لگائیں" },
  ];

  return (
    <TalbaLayout title="شعبہ تجوید ڈیش بورڈ">
      {error && (
