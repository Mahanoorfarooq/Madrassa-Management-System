...
export default function HifzDashboard() {
  ...
  const quickLinks = [
    {
      href: "/talba/students?dept=HIFZ",
      label: "نیا طالب علم شامل کریں",
      icon: UserPlus,
      color: "bg-blue-500",
    },
    {
      href: "/talba/teachers?dept=HIFZ",
      label: "نیا استاد شامل کریں",
      icon: GraduationCap,
      color: "bg-green-500",
    },
    {
      href: "/talba/classes?dept=HIFZ",
      label: "نئی کلاس بنائیں",
      icon: PlusCircle,
      color: "bg-purple-500",
    },
    {
      href: "/talba/attendance?dept=HIFZ",
      ...
      <div className="space-y-6" dir="rtl">
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl shadow-lg p-6 text-white">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold mb-1">شعبہ حفظ القرآن</h1>
                ...
                {quickLinks.map((link) => {
                  ...
                  return (
                    <Link
                      key={link.href}
                      href={link.href}
                      className="group relative overflow-hidden rounded-xl border-2 border-gray-200 bg-gradient-to-br from-white to-gray-50 hover:border-emerald-400 transition-all duration-300 shadow-sm hover:shadow-md p-5"
                    >
                      <div className="flex items-center gap-4">
                        <div
                        ...
                        <ArrowLeft className="w-5 h-5 text-gray-400 group-hover:text-emerald-600 group-hover:translate-x-1 transition-all duration-300" />
                      </div>
                    </Link>
                  );
                })}
