...
export default function MudeerDashboard() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      // lightweight polling to keep dashboard in sync
      api
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="flex justify-between items-center mb-8">
              <div>
                <h3 className="text-lg font-bold text-gray-800">
                  آج کی حاضری کی صورتحال
                </h3>
                <p className="text-xs text-gray-500">
                  مجموعی حاضری کا گرافیکل جائزہ
                </p>
              </div>
              ...
              <Bar
                ...
                options={{
                  ...
                  scales: {
                    ...
                    x: {
                      grid: { display: false },
                      ticks: { font: { size: 12, family: "Urdu" } },
                    },
                  },
                }}
              />
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center">
            <div className="w-full mb-6">
              ...
              <p className="text-xs text-gray-500">
                فیسوں کی وصولی بمقابلہ بقایا جات
              </p>
            </div>
          ...
          <div className="flex justify-between items-end mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">
                سسٹم کے تمام انتظامی ماڈیولز تک براہِ راست رسائی
              </p>
            </div>
            <Link
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              <Link
                href="/admin/tickets"
                className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100 group hover:border-primary/30 transition-colors"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500">
                      طلبہ کی جانب سے بھیجی گئی درخواستیں
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
              ...
              <Link
                href="/admin/tickets"
                className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100 group hover:border-primary/30 transition-colors opacity-60"
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500">
                      نئے رجسٹرڈ ہونے والے طلبہ
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-lg font-black text-gray-800">
                    {data.pendingApprovals.admissions}
                  </span>
                  <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-primary transition-colors" />
                </div>
              </Link>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div className="flex-1 bg-amber-50 p-4 rounded-2xl border border-amber-100">
                  ...
                  <h4 className="text-2xl font-black text-amber-800">
              ...
              <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 border-dashed text-center">
                <p className="text-[10px] text-gray-500 italic">
                  سسٹم کی کارکردگی بہتر بنانے کے لیے تمام ٹکٹس کو وقت پر حل
                  کریں۔
                </p>
              </div>
            </div>
