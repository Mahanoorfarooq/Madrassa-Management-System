    ...
    try {
      ...
      if (token && typeof window !== "undefined") {
        ...
        if (data.allowedModules) {
          localStorage.setItem("allowed_modules", JSON.stringify(data.allowedModules));
        }
      }
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 opacity-80 group-hover:translate-x-1 transition-transform">
                    <path fillRule="evenodd" d="M15.75 2.25H21a.75.75 0 01.75.75v18a.75.75 0 01-.75.75h-5.25a.75.75 0 010-1.5H20.25V3.75h-4.5a.75.75 0 01-.75-.75zm6.133 8.683a.75.75 0 010 1.06l-4.25 4.25a.75.75 0 01-1.06-1.06L19.438 10.5 16.5 7.562a.75.75 0 011.06-1.06l4.25 4.25z" clipRule="evenodd" />
                    <path fillRule="evenodd" d="M12.75 12a.75.75 0 01.75.75v.01l-6 .005a.75.75 0 010-1.5l6-.005V12z" clipRule="evenodd" />
                  </svg>
                </>
              )}
            </button>
